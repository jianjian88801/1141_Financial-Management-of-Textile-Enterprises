    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报销名目" prop="baoxiaoName">
                       <el-input v-model="ruleForm.baoxiaoName"
                                 placeholder="报销名目" clearable  :readonly="ro.baoxiaoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="报销名目" prop="baoxiaoName">
                           <el-input v-model="ruleForm.baoxiaoName"
                                     placeholder="报销名目" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="报销类型" prop="baoxiaoTypes">
                        <el-select v-model="ruleForm.baoxiaoTypes" :disabled="ro.baoxiaoTypes" placeholder="请选择报销类型">
                            <el-option
                                v-for="(item,index) in baoxiaoTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="报销类型" prop="baoxiaoValue">
                        <el-input v-model="ruleForm.baoxiaoValue"
                            placeholder="报销类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报销金额" prop="baoxiaoMoney">
                       <el-input v-model="ruleForm.baoxiaoMoney"
                                 placeholder="报销金额" clearable  :readonly="ro.baoxiaoMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="报销金额" prop="baoxiaoMoney">
                           <el-input v-model="ruleForm.baoxiaoMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报销详情" prop="baoxiaoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.baoxiaoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.baoxiaoContent" label="报销详情" prop="baoxiaoContent">
                            <span v-html="ruleForm.baoxiaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    insertTime: false,
                    baoxiaoMoney: false,
                    baoxiaoContent: false,
                    baoxiaoYesnoTypes: false,
                },
                ruleForm: {
                    yuangongId: '',
                    baoxiaoName: '',
                ...
                rules: {
                   ...
                   baoxiaoName: [
                              { required: true, message: '报销名目不能为空', trigger: 'blur' },
                          ],
                   baoxiaoTypes: [
                   ...
                   baoxiaoContent: [
                              { required: true, message: '报销详情不能为空', trigger: 'blur' },
                          ],
                   baoxiaoYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoxiao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.baoxiaoTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoxiao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.baoxiaoYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`baoxiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.baoxiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
