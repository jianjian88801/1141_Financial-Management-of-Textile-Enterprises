            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   ...
                   <!--<div v-else>-->
                       ...
                       <!--</el-form-item>-->
                   <!--</div>-->
                   <el-form-item v-if="type!='info'"  class="input" label="月份" prop="shoufeiTime">
                       <el-date-picker
                               value-format="yyyy-MM"
                               v-model="ruleForm.xinziMonth"
                               type="month"
                               placeholder="收费时间"
                               :disabled="ro.xinziMonth">
                       </el-date-picker>
                   </el-form-item>
                   <div v-else>
                       <el-form-item v-if="ruleForm.xinziMonth" label="月份" prop="shoufeiTime">
                           <span v-html="ruleForm.xinziMonth"></span>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="薪资" prop="jine">
                       <el-input v-model="ruleForm.jine"
                                 placeholder="薪资" clearable  :readonly="ro.jine"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="薪资" prop="jine">
                           <el-input v-model="ruleForm.jine"
